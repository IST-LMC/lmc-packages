...
/* Define to 1 if you have the `abort2' function. */
/* #undef HAVE_ABORT2 */
...
/* Define to 1 if you have the `pthread_mutex_isowned_np' function. */
/* #undef HAVE_PTHREAD_MUTEX_ISOWNED_NP */
...
#define PACKAGE_STRING "Varnish 3.0.5"
...
/* Define if SENDFILE works */
/* #undef SENDFILE_WORKS */

/* Define if SO_RCVTIMEO works */
#define SO_RCVTIMEO_WORKS 1

/* Define if SO_SNDTIMEO works */
...
#define VCC_CC "exec gcc -std=gnu99  -pthread -fpic -shared -Wl,-x -o %o %s"
